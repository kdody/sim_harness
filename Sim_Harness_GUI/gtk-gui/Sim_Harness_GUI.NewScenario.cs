...
namespace Sim_Harness_GUI
{
	public partial class NewScenario
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget Sim_Harness_GUI.NewScenario
			this.Name = "Sim_Harness_GUI.NewScenario";
			this.Title = global::Mono.Unix.Catalog.GetString ("New Senario");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child Sim_Harness_GUI.NewScenario.VBox
			global::Gtk.VBox w1 = this.VBox;
			w1.Name = "dialog1_VBox";
			w1.BorderWidth = ((uint)(2));
			// Internal child Sim_Harness_GUI.NewScenario.ActionArea
